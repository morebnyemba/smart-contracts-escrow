    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_at', models.DateTimeField(blank=True, help_text='Date when profile was verified', null=True)),
                ...
                ('skills', models.ManyToManyField(blank=True, related_name='sellers', to='users.servicecategory')),
            ],
            options={
